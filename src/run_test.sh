...
python generate_aspect_tagger_input_data.py  -f '../data/json_data/acl17.json' -v 'acl17'
...
for YEAR in {2018..2021}; do
    python create_iclr_json.py -y $YEAR -l 5;
    python create_iclr_corpus.py -y $YEAR -l 5;
